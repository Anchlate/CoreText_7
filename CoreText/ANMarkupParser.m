...
-(id)init
{
    ...
    if (self) {
        ...
        //        self.font = @"Arial";
        self.font = [self postscriptNameFromFullName:@"Arial"];
...
{
    UIFont *font1 = [UIFont fontWithName:fullName size:1];
    return (__bridge NSString *)(CTFontCopyPostScriptName((__bridge CTFontRef)(font1)));
}
